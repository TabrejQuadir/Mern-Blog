      ...
      >
        ...
        <Modal.Body>
          <div className='text-center'>
            <HiOutlineExclamationCircle className='h-14 w-14 text-gray-600 dark:text-gray-500 mb-4 mx-auto' />
            <h3 className='mb-5 text-lg text-gray-700 dark:text-gray-400'>
